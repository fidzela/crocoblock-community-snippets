...
class Cancel_Subscription extends Rest_Api_Endpoint_Base {
	...
	public static function get_rest_base() {
		return '/stripe/subscription/cancel/(?P<id>[\d]+)'; // CLAUDE -> referenciando api -> verificar
	}
	...
	public function run_callback( \WP_REST_Request $request ) {
		...
		try {
			...
			$resp = wp_remote_request(
				// 'https://api.stripe.com/v1/subscriptions/' . rawurlencode( $billing_id ), // CLAUDE -> VERIFICAR REFERENCIA API
				array(
					'method'  => 'DELETE',

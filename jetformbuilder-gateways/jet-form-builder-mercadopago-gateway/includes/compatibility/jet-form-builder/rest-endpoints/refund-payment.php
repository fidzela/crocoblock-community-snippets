...
class Refund_Payment extends Rest_Api_Endpoint_Base {
	...
	public static function get_rest_base() {
		return 'stripe/payment/refund/(?P<id>\d+)'; // CLAUDE
	}
	...
	public function run_callback( \WP_REST_Request $request ) {
		...
		$resp = wp_remote_get(
			//CLAUDE VERIFICAR'https://api.stripe.com/v1/invoice_payments?invoice=' . rawurlencode( $invoice_id ) . '&status=paid&limit=1',
			array(
		...
		$refund_resp = wp_remote_post( 'https://api.stripe.com/v1/refunds', $args ); //CLAUDE

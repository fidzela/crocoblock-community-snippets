...
function MercadopagoMain(_ref) {
  ...
  return wp.element.createElement(React.Fragment, null, noticeUI, wp.element.createElement(ToggleControl, {
    ...
    key: "mercadopago_client_id_setting",
    ...
    key: "mercadopago_secret_setting",
  ...
  }), renderGateway('mercadopago', {
    noticeOperations: noticeOperations
  }, scenario));
}
/* harmony default export */ __webpack_exports__["default"] = (compose(withSelect(withSelectGateways), withDispatch(withDispatchGateways), withNotices)(MercadopagoMain));
...
function MercadopagoPayNowScenario(_ref) {
...
function MercadopagoSubscriptionScenario(_ref) {
        ...
        while (1) switch (_context.n) {
          case 0:
            ...
            return wp.apiRequest({
              path: '/jet-form-builder/v1/fetch-mercadopago-plans',
              method: 'POST',
              data: {
                public: getSpecificOrGlobal('public'),
                secret: getSpecificOrGlobal('secret'),
...
/* harmony default export */ __webpack_exports__["default"] = (compose(withSelect(function () {
  ...
  return _objectSpread({}, withDispatchGateways.apply(void 0, arguments));
}))(MercadopagoSubscriptionScenario));
